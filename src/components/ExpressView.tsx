...
const LOCALES = [
  { key: "lince_arenales", name: "Litio San Isidro", address: "Av. Arenales 2584, San Isidro", short: "San Isidro" },
  ...
  { key: "lince_leal", name: "Litio Lince Leal", address: "Av. Jose Leal 571, Lince", short: "Lince" }
];
